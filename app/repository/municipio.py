...
class MunicipioRepository(ImpalaRepository):
    ...
    NAMED_QUERIES = {
        ...
        'QRY_FIND_BY_CODE': '''SELECT cd_municipio_ibge,cd_municipio_ibge_dv,
            st_situacao,cd_municipio_sinpas,cd_municipio_siafi,nm_municipio,
            nm_municipio_sem_acento,ds_observacao,cd_municipio_sinonimos,
            cd_municipio_sinonimos_dv,st_amazonia,st_fronteira,st_capital,
            cd_uf,ano_instalacao,ano_extincao,cd_municipio_sucessor,
            latitude,longitude,altitude,area,nm_uf,sg_uf,nm_municipio_uf,
            cd_unidade,cd_prt,nm_prt,nm_unidade,tp_unidade,sg_unidade,
            cd_mesorregiao,nm_mesorregiao,cd_microrregiao,nm_microrregiao,
            nu_portaria_mpt,tp_area,cd_geomunicipio_ibge,cd_municipio_rfb,
            cd_regiao,nm_regiao 
