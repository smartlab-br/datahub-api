...
class QueryBuilderTransformCategoriasTest(unittest.TestCase):
    ''' Classe que testa a validação do field array '''
...
class QueryBuilderCatchInjectionTest(unittest.TestCase):
...
class QueryBuilderTransformJoindeCategoriasTest(unittest.TestCase):
...
class QueryBuilderBuildGroupingStringTest(unittest.TestCase):
    ...
    def test_void_categories(self):
        ...
        self.assertRaises(
            ValueError,
            QueryBuilder.build_grouping_string,
            cats,
            agrs
        )
...
class QueryBuilderGetAgrStringTest(unittest.TestCase):
...
class QueryBuilderValidateClauseTest(unittest.TestCase):
    ...
    def test_valid_join_com_sufixo(self):
        ''' Sinaliza positivamente quando é um filtro de join
            e tem um sufixo '''
        result = QueryBuilder.validate_clause(['eq', 'any_mun'], 'municipio', True, '_mun')
        self.assertEqual(result, True)

    def test_valid_out_join_sem_sufixo(self):
        ''' Sinaliza positivamente quando é um filtro fora do
            join e não tem um sufixo '''
        result = QueryBuilder.validate_clause(['eq', 'any'], 'municipio', False, '_mun')
        self.assertEqual(result, True)

    def test_invalid_join_sem_sufixo(self):
        ''' Sinaliza negativamente quando é um filtro de join
            e não tem um sufixo '''
        result = QueryBuilder.validate_clause(['eq', 'any'], 'municipio', True, '_mun')
        self.assertEqual(result, False)

    def test_invalid_out_join_sufixo(self):
        ''' Sinaliza negativamente quando é um filtro fora do
            join e tem um sufixo '''
        result = QueryBuilder.validate_clause(['eq', 'any_mun'], 'municipio', False, '_mun')
        self.assertEqual(result, False)

class QueryBuilderGetSimpleAgrStringTest(unittest.TestCase):
    ...
    def test_invalid(self):
        ...
        self.assertRaises(
            ValueError,
            QueryBuilder.get_simple_agr_string,
            agr,
            vlr
        )
