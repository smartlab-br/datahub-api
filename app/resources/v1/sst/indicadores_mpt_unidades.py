...
from model.sst.indicadores_mpt_unidades import IndicadoresSSTMptUnidades

class IndicadoresSSTMptUnidadesResource(BaseResource):
    ...
    def __init__(self):
        ''' Construtor'''
        self.domain = IndicadoresSSTMptUnidades()
